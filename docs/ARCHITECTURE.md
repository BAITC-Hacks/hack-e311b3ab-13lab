...
| --- | --- |
| `app/main.py` | API, загрузка, проверка прав, жизненный цикл и очередь |
| `app/rbac.py` | Роли, права и права на конкретное совещание |
| `app/security.py` | Хеширование паролей scrypt, токены сессий |
| `app/blobs.py` | Хранилище записей и файлов протоколов |
| `app/config.py` | Конфигурация окружения |
| `app/models.py` | Валидируемые структуры данных |
| `app/store.py` | SQLAlchemy: совещания, пользователи, сессии, журнал; версии документов |
