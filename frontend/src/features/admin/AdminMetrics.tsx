...
const COLORS: Record<MeetingStatus, string> = { live: '#d9534f', approved: '#1b4a44', ready: '#bad98b', queued: '#c6d5e0', transcribing: '#8bafc3', diarizing: '#819db9', analyzing: '#6585a4', failed: '#cd8170' }
const STATUSES: MeetingStatus[] = ['live', 'approved', 'ready', 'queued', 'transcribing', 'diarizing', 'analyzing', 'failed']
